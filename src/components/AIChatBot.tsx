  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full shadow-xl bg-[var(--foreground)] text-[var(--background)] hover:opacity-90 transition-all ${
